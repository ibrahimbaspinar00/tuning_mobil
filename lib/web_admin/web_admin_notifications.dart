    ...
    try {
      ...
      if (_selectedTarget == 'all') {
        ...
        await _notificationService.sendNotification(
          ...
          data: {
            'action': _actionUrlController.text.isNotEmpty ? 'navigate' : null,
            'url': _actionUrlController.text.isNotEmpty ? _actionUrlController.text : null,
          },
          scheduledAt: _scheduledDate != null && _scheduledTime != null
              ? DateTime(
                  _scheduledDate!.year,
